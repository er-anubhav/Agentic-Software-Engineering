...
from src.application.orchestration.autonomy.goal_manager import GoalLifecycleManager, Goal, GoalStatus, GoalPriority
from src.application.orchestration.autonomy.observation_engine import ObservationEngine, Observation
from src.application.orchestration.autonomy.progress_engine import ProgressEngine, ProgressReport
...
from src.application.orchestration.autonomy.goal_validator import GoalValidator, ValidationResult
