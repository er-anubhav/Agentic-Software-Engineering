...
from src.application.orchestration.autonomy.observation_engine import Observation
from src.application.orchestration.autonomy.progress_engine import ProgressReport
