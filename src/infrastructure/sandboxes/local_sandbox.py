...
import subprocess
import time
from src.infrastructure.sandboxes.base_sandbox import BaseSandbox, SandboxConfig, SandboxResult
class LocalSandbox(BaseSandbox):
    ...
    def _resolve_safe_path(self, relative_path: str) -> str:
        ...
        if not full_path.startswith(self.workspace_dir):
            raise PermissionError(f"Path traversal attack detected: '{relative_path}' outside workspace.")
        return full_path
